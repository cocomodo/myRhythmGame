...
public class FxPool : MonoBehaviour
    {
        ...
        public ObjectPool greenNoteExplosion;
        ...
        private readonly List<ObjectPool> noteExplosions = new List<ObjectPool>();
        ...
        private void Awake()
        {
            ...
            Assert.IsNotNull(greenNoteExplosion);
            ...
            noteExplosions.Add(greenNoteExplosion);
            // noteExplosions.Add(greenCandyExplosion);
            // noteExplosions.Add(orangeCandyExplosion);
            // noteExplosions.Add(purpleCandyExplosion);
            // noteExplosions.Add(redCandyExplosion);
            // noteExplosions.Add(yellowCandyExplosion);
        ...
        public ObjectPool GetNoteExplosionPool(NoteColor color)
        {
            return noteExplosions[(int) color];
        }
        // /// <summary>
